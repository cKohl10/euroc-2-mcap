...
Clone the <span style="color: red;">TODO-></span>[code repository](https://github.com/cKohl10/euroc-2-mcap) for this tutorial. In a new python virtual environment, install the following dependencies:
```bash
